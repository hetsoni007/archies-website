...
All images in this folder were downloaded from **Aarchi's own Instagram**
(@aarchis.byarchanasoni) on 2026-06-26 for use on the brand's own website.

⚠️ **Before public launch:** confirm usage rights for shoots that credit external
photographers/MUAs/models (listed below). These are the brand's commissioned shoots,
so it's almost certainly fine — but get explicit OK from the credited photographers.
Also consider re-exporting to WebP for performance (currently Instagram-compressed JPEG, 1080px).
